...
const FAQSScreen = () => {
    return (
        <div>
            ...
            <h3>FAQs : </h3>
            <p>
            Kindly check the FAQ below if you are not very familiar with the functioning of this website. If your query is of urgent nature and is different from the set of questions then do write to us at customerservice@GROCETERIA.in or call us on 8770147603 between 10 am & 5 pm on all days including Sunday to get our immediate help.
            </p>
            <h5>Registration : </h5>
