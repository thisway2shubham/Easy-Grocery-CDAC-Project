...
const TermAndConditionScreen = () => {
    return (
        <div>
            ...
            <p>GROCETERIA is the licensed owner of the brand mygreenmart.in 
                and the website mygreenmart.in (”The Site”).GROCETERIA
                 respects your privacy. This Privacy Policy provides succinctly 
                 the manner your data is collected and used by GROCETERIA on 
                 ...
                 use of your data by GROCETERIA in the manner provided in this 
                 Privacy Policy.
            </p>
            <br/>
            <h5>Services overview
</h5>
            <p>As part of the registration process on the Site, GROCETERIA 
            ...
            <p>GROCETERIA grants you a limited sub-license to access and make 
                ...
                written consent of GROCETERIA. This license does not include 
                ...
                express written consent of GROCETERIA. You may not frame or utilize 
                ...
                of GROCETERIA and its affiliates without express written consent. 
                You may not use any meta tags or any other “hidden text” utilizing the 
                Site’s or GROCETERIA's name or MGM’s name or trademarks without the 
                express written consent of GROCETERIA. Any unauthorized use terminates 
                the permission or license granted by GROCETERIA</p>
            <br/>
        </div>
        </div>
    );
